...
#ifndef __EDITINSTANTMESSAGING_H__
#define __EDITINSTANTMESSAGING_H__

#include "EditField.h"

#include "Observer.h"

class EditInstantMessaging:
	public EditField,
	public Observer
{
	public:
		 ...
		 */
		EditInstantMessaging(PIM::Contact* contact);

		/**
		 * Destructor.
		 */
		~EditInstantMessaging();
	...
	private:
		 ...
		 */
		void addProtocol(int index, const char* text);
		...
		/**
		 * Button widget for protocol.
		 */
		MAUtil::Vector<NativeUI::Button*> mProtocols;

		/**
		 * True if choose protocol dialog is opened.
		 */
		bool bChooseProtocol;
};

#endif /* __EDITINSTANTMESSAGING_H__ */
