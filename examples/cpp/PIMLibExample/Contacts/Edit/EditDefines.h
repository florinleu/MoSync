...
#define EDIT_IM_FLAGS					0x1
#define EDIT_NOTE_FLAGS					0x1
#define EDIT_ORGANIZATION_FLAGS			0x7F
#define EDIT_SP_FLAGS					0x7
#define EDIT_EVENT_FLAGS				0x1
#define EDIT_RELATION_FLAGS				0x1
